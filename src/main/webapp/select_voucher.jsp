...
<main>
    <div class="voucher-page-container">
        ...
        <div class="voucher-list">
            ...
            <label class="voucher-card eligible">
                <div class="v-left">
                    <div class="v-icon-box freeship">
                ...
                <div class="v-right">
                    ...
                    <input type="radio" name="selected_voucher" style="width: 20px; height: 20px;">
                </div>
            </label>
            ...
            <label class="voucher-card eligible">
                ...
                <div class="v-right">
                    <div class="v-info">
                        <h4>Tối đa 25k</h4>
                        <p>Đơn Tối Thiểu 150k</p>
                        <small>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right: 5px;"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                            Có hiệu lực đến 30.12.2026
                        </small>
                    </div>
                    <input type="radio" name="selected_voucher" style="width: 20px; height: 20px;">
                </div>
            ...
            <div class="voucher-list-title" style="padding-left: 0; padding-top: 10px;">Mã Giảm Giá / Hoàn Tiền</div>

            <label class="voucher-card ineligible">
                <div class="v-left">
                    <div class="v-icon-box disabled">
                ...
                <div class="v-right">
                    <div class="v-info">
                        <h4>Giảm 15%</h4>
                        <p>Đơn Tối Thiểu 2.000.000đ</p>
                        <small>Chưa đạt giá trị đơn hàng tối thiểu</small>
                    </div>
        ...
        <div class="voucher-footer">
            <button class="btn-ok" onclick="window.location.href='checkout.jsp'">ĐỒNG Ý</button>
        </div>
    </div>
</main>
